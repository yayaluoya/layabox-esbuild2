...
(function () {
  ...
  console.log(
    ...esbuildTool.consoleEx.textPack(
      ...
      `欢迎使用${esbuildTool.config.packageJson.name}构建工具，该工具只是个外壳不会修改项目任何内容🌝。\n当前版本 @${esbuildTool.config.packageJson.version} 最新版本请查看 ${esbuildTool.config.packageJson.repository.url}`,
    ),
  );
  //打印浏览器提示
